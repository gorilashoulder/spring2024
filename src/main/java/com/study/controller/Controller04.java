...
public class Controller04 {
    ...
    // /main4/sub1?city
    // /main4/sub1?country
    // /main4/sub1?country&city
    // /main4/sub1?country=korea&city=seoul
    @RequestMapping("sub1")
    ...
    // /main4/sub?name=son&age=44&city=london&country=uk
    @RequestMapping("sub2")
    ...
    public void sub4(WebRequest request) {
        ...
        if (value != null) {
            System.out.println(value + "검색결과실행");
            System.out.println("검색결과응답");
        }
    }
    ...
    // /main4/sub6?weight=60
    // /main4/sub6?weight=100

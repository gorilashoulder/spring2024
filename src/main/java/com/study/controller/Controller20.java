...
public class Controller20 {
    ...
    public void sub6(String address, String type, Model model) {
        model.addAttribute("address", address + " 의 " + type + " 검색결과");
    }
    ...
    @RequestMapping("sub9")
    public void sub9(@ModelAttribute MyBean201 data) {
        System.out.println("data = " + data);
    }

    @RequestMapping("sub10")
    public void sub10(@ModelAttribute MyBean202 obj) {

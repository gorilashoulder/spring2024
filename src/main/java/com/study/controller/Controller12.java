...
public class Controller12 {
    ...
    public void method4(Model model) {
        ...
        model.addAttribute("food", List.of("피자", "햄버거", "찌개", "돈까스"));
        ...
        model.addAttribute("myList2", List.of("banana", "melon", "apple", "peaches"));
        model.addAttribute("myMap2", Map.of("otani", "LA", "messi", "maiami", "ronaldo", "alnasr"));
    }
    ...
    public void method6(Model model) {
        ...
        MyBean121 e3 = new MyBean121("xc90", "volvo", "스웨덴", 6000);
    ...
    public void method7(Model model) {
        ...
        MyBean122 e2 = new MyBean122("김하성", "SD", "한국", "야구", List.of("유격수", "2루수"));
        MyBean122 e3 = new MyBean122("오타니", "LA", "일본", "야구", List.of("투수", "타자"));

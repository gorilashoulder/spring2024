...
public class Controller10 {
    ...
    public void method2(Model model) {
        ...
        data.add(Map.of("korea", "seoul", "japan", "도쿄", "미국", "워싱턴"));
    ...
    public void method5(Model model) {
        model.addAttribute("data", "값1");
        model.addAttribute("데이타", "값2");
    ...
    public void method9(Model model) {
        ...
        e1.setCity("서울");
        e1.setFoods(List.of("불고기", "떡볶이", "비빔밥"));
        e2.setCity("부산");
        e2.setFoods(List.of("피자", "치킨", "햄버거"));
